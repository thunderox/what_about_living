...
new_object("Small weights", "Small training weights is this what Sam wanted?", "", 12, 50, 50, true );
new_object("Ankle weights", "Heavy weights to put on your ankles, are these what Sam wanted?", "", 13, 50, 50, true );
new_object("Heart rate monitor", "Wow, I'm surprised it still works, is this what Sam wanted?", "", 17, 50, 50, true );
new_object("Exercise expander", "Oh! it's one of those stretch exapnder things, is this what Sam wanted?", "", 18, 50, 50, true );
new_object("Abandoned sweater", "Wow so soft...... maybe Elissa would like this?", "", 12, 50, 50, true );
new_object("A pile of clothes", "Were people swimming in the fountain... maybe Elissa would like this?", "", 17, 50, 50, true );
new_object("Forgotten underwear", "Why are these here? Maybe Elissa would like this?", "", 19, 50, 50, true );
